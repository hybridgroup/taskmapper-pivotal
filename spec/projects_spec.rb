...
describe "TaskMapper::Provider::Pivotal::Project" do
  ...
  pending "should be able to load projects from an array of ids" do
  ...
  pending "should be able to find a project" do
  ...
  pending "should be able to find a project by attributes" do
  ...
  pending "should be able to update and save a project" do
  ...
  pending "should be able to create a project" do
